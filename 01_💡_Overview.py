...
st.image('./img/img_rhk.png', width=600, caption='Sunrise by the mountains')
...
st.image('./img/img2.png', width=600, caption='Sunrise by the mountains')
...
st.image('./img/img1_1.png', caption='Sunrise by the mountains')
